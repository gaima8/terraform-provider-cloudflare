...
func resourceCloudflareCustomHostnameDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return errors.Wrap(err, "failed to delete custom hostname %q", hostnameID)
	}
...
func resourceCloudflareCustomHostnameCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return errors.Wrap(err, "failed to create custom hostname %q", certificate.Hostname)
	}
...
func resourceCloudflareCustomHostnameUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return errors.Wrap(err, "failed to update custom hostname %q, with ID %q", certificate.Hostname, hostnameID)
	}
